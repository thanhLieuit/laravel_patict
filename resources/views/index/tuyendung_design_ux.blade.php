		...
		<div class="row page-titles">
	        <div class="col-md-6 align-self-center">  
	            <ul class="breadcrumb" style="background-color: #e9ecef00;">
	                ...
	                <li style="padding-left: 10px;padding-right: 10px;"><i class='fas fa-angle-double-right'></i></li>
	                <li class="">{{ trans('messages.recruitment1') }}</li>
	            </ul>
	        </div>
			...
			<div class="col-md-6">
				<div class="ndtuyendungdesign">
					<div class="titledesign">
						...
						<p>{{ trans('messages.p-1') }}</p>
						<p>{{ trans('messages.p-2') }}</p>
						<p>{{ trans('messages.p-3') }}</p>
						<p>{{ trans('messages.p-4') }}</p>
						<p>{{ trans('messages.p-5') }}</p>
						<p>{{ trans('messages.p-6') }}</p>
						<br>
						<h3>{{ trans('messages.title2') }}</h3>
						<p>{{ trans('messages.p2-1') }}	</p>
						<p>{{ trans('messages.p2-2') }}</p>
						<p>{{ trans('messages.p2-3') }}</p>
						<p>{{ trans('messages.p2-4') }}</p>
						<p>{{ trans('messages.p2-5') }}</p>
...
@endif
							...
							<div class="row">
								<div class="col-md-6">
									<div class="radio" style="float: left;margin-right: 20px;">
						    			<input type="radio" name="optradio" value="Thiết kế đồ họa & website">{{ trans('messages.vt-1') }}
						    		</div>
								</div>
								<div class="col-md-6">
									<div class="radio">
						     			<input type="radio" name="optradio" value="Front-end Developer">Front-end Developer
						    		</div>
								</div>
							</div>    
						</div>
						...
						<div class="form-group knlm">
							<label for=""><h5>{{ trans('messages.form-10') }}</h5></label><br>
