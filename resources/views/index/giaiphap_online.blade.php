...
<section id="banner">
	<div class="full-container">
		<div class="bannergp">
			<img src="{!! asset('index/img/MO-banner.png') !!}" alt="hình banner marketing online">
		</div>	
	</div>		
</section>
<br>
		...
		<div class="row page-titles">
	        <div class="col-md-6 align-self-center">  
	            <ul class="breadcrumb" style="background-color: #e9ecef00;">
	                ...
	                <li style="padding-left: 10px;padding-right: 10px;"><i class='fas fa-angle-double-right'></i></li>
	                <li class="">{{ trans('messages.solution33') }}</li>
	            </ul>
	        </div>
...
<section id="giaiphapthuongmai">
	<div class="container">
		<div id="PAT_MANG___N_NH_NG_GI_I_PH_P_T">
			<p>{{ trans('messages.solution-mk') }}<br/>{{ trans('messages.solution-mk1') }} </p>
		</div>
		<div id="B_t_k__kh_ch_h_ng_c_a_b_n_____">
			<p>{{ trans('messages.solution-mk2') }}</p>
		</div>
		<div class="row">
			<div class="col-md-4">
				<div class="hinhgptm">
					<img src="{!! asset('index/img/MO-1.png') !!}" alt="hình banner marketing online">
				</div>
				<br>
				<div id="GI_I_PH_P_TO_N_DI_N_CHO_DOANH_">
					<p> {{ trans('messages.solution-mk3') }}</p>
				</div>
				<div id="Gi_i_ph_p_th__ng_m_i__i_n_t__c">
					<p>{{ trans('messages.solution-mk4') }}</p>
				</div>
			</div>
			<div class="col-md-4">
				<div class="hinhgptm">
					<img src="{!! asset('index/img/MO-2.png') !!}" alt="hình banner marketing online">
				</div>
				<br>
				<div id="GI_I_PH_P_TO_N_DI_N_CHO_DOANH_">
					<p> {{ trans('messages.solution-mk5') }}</p>
				</div>
				<div id="Gi_i_ph_p_th__ng_m_i__i_n_t__c">
					<p>{{ trans('messages.solution-mk6') }}</p>
				</div>
			</div>
			<div class="col-md-4">
				<div class="hinhgptm">
					<img src="{!! asset('index/img/MO-3.png') !!}" alt="hình banner marketing online">
				</div>
				<br>
				<div id="GI_I_PH_P_TO_N_DI_N_CHO_DOANH_">
					<p> {{ trans('messages.solution-mk7') }}</p>
				</div>
				<div id="Gi_i_ph_p_th__ng_m_i__i_n_t__c">
					<p>{{ trans('messages.solution-mk8') }}</p>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="col-md-12">
			<div class="row">
					...
					<div id="Group_1461">
						<div id="Group_906">
							<div id="B_N_C_N_TH_M_TH_NG_TIN_">
								<h1> {{ trans('messages.solution-mk9') }}</h1>
							</div>
						</div>
						<div id="Group_265">
							<div id="B_n_mu_n_bi_t_r__h_n_v__c_c_d_">
								<p>{{ trans('messages.solution-mk10') }}</p>
							</div>
							<div class="row">
								<div class="col-md-6">
				...
				<div class="col-md-6">
					<div class="hinhttt">
						<img src="{!! asset('index/img/MO-4.png')!!}" alt="hình banner marketing online">
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="tieudegiapphap1">
						<h2>{{ trans('messages.solution-mk11') }}</h2>
						<p>{{ trans('messages.solution-mk12') }}</p>
						<p>{{ trans('messages.solution-mk13') }}</p>
						<p>{{ trans('messages.solution-mk14') }}</p>
					</div>
				</div>
				<div class="col-md-6">
					<div class="hinhphai1">
						<img src="{!! asset('index/img/marketing-online-la-gi-trong-ky-nguyen-so-4.0-1.jpg')!!}" alt="">
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6 order-md-2">
					<div class="space50">&nbsp;</div>
					<div class="tieudegiapphap1">
						<h2>{{ trans('messages.solution-mk15') }}</h2>
						<p>{{ trans('messages.solution-mk16') }}</p>
						<p>{{ trans('messages.solution-mk17') }}</p>
						<p>{{ trans('messages.solution-mk18') }}</p>
						<p>{{ trans('messages.solution-mk19') }}</p>
						<p>{{ trans('messages.solution-mk20') }}</p>
					</div>
					<div id="Btn___i_t_c_dv_gp">
				...
				<div class="col-md-6 order-md-1">
					<div class="hinhphai1">
						<img src="{!! asset('index/img/influencer-concept-illustration_23-2148277344.jpg')!!}" alt="">
					</div>
				</div>
			</div>
		</div>
